...
export function CustomSearchBar({ placeholder = "Search here..." }: { placeholder?: string }) {
  ...
  return (
    <div className="relative w-full group">
      ...
      <Input
        className="w-full rounded-full bg-[#FAFAFA] hover:bg-gray-200 pl-12 pr-2 h-9 focus-visible:ring-0 border-0 text-2xl transition-colors duration-300 placeholder:text-gray-400"
