  ...
  return (
    <div className="space-y-10 ps-4 xl:ps-6">
      ...
      <div className="flex gap-3">
        ...
        <CustomModal trigger={<button className="bg-[#F2F2F2] rounded-full px-4 py-1 text-sm text-gray-700 cursor-pointer">Add Note</button>} title={"Add Note"} >
          <EditCustomer id={id} />
        </CustomModal>
        <Link href="/?id=1" className="bg-[#F2F2F2] rounded-full px-4 py-1 text-sm text-gray-700 cursor-pointer flex items-center">Chat</Link>
      </div>
    </div>
  );
}
